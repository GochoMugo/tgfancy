...
exports = module.exports = class Tgfancy extends TelegramBot {
    ...
    constructor(token, options={}) {
        ...
        const opts = _.defaultsDeep({
            ...
            webSocket: options.tgfancy.webSocket ? {} : null,
        }, options.tgfancy, defaults);

        // Perform parameter validation
        if (opts.webSocket && (options.polling || options.webHook)) {
            throw new Error("WebSocket, Polling and WebHook are all mutually exclusive");
        }
        ...
        this.tgfancy.resolveChatId = Promise.promisify(this.tgfancy.resolveChatId);
        ...
        // chat ID.
        if (this.tgfancy.chatIdResolution) {
            ...
            function exec(resolve, reject) {
                method.call(self, ...args)
                    ...
                    .catch(function(error) {
                        ...
                        const opts = self.tgfancy.ratelimitingOptions;
                        retry++;
    ...
    _resolveChatId(method, options={}) {
        ...
        return function() {
            ...
            return Promise.mapSeries(usernames, function(username) {
                ...
                return self.tgfancy.resolveChatId(self.token, username)
    ...
    _emojify(method, methodDesc) {
        ...
        return function() {
            ...
            const emojifiedText = self.tgfancy.emojify(text);
